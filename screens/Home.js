...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
    const url = "http://7270-122-176-220-62.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "http://7270-122-176-220-62.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "http://7270-122-176-220-62.ngrok.io/unliked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "http://7270-122-176-220-62.ngrok.io/did-not-watch";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
